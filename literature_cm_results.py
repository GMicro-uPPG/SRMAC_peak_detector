...
train_cm = peak_detector.literature_record_set_confusion_matrix(train_records, False, 10)
test_cm = peak_detector.literature_record_set_confusion_matrix(test_records, False, 10)
